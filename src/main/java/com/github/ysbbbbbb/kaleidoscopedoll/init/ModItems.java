...
public final class ModItems {
    ...
    public static void registerItems() {
        ...
        Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(KaleidoscopeDoll.MOD_ID, "doll_0"), DOLL_AUTHOR_YSBB);
        Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(KaleidoscopeDoll.MOD_ID, "doll_1"), DOLL_AUTHOR_943);
